...
> 현재 프론트엔드는 Next.js 16이며 개발 포트는 3000입니다. 백엔드 연결에 필요한 API 계약과 현재 임시 저장 구조는 [프론트엔드 → 백엔드 연동 인계서](docs/FRONTEND_BACKEND_HANDOFF.md)를 먼저 확인하세요. 아래 일부 초기 구조 설명은 현재 구현과 다를 수 있습니다.
