...
<p align="center"><a href="../architecture/data_pipeline.html"><img src="../images/data_pipeline.gif" width="95%" alt="데이터 수집 · 전처리 · 인덱싱 흐름 (움직이는 그림)"/></a></p>

<sub>▶ 선을 따라 흐름이 움직입니다 · 정지 그림 <a href="../images/data_pipeline.png">PNG</a> · <a href="../images/data_pipeline.svg">SVG</a> · PPT용 영상 <a href="../media/data_pipeline.mp4">MP4</a> · 클릭하면 확대 · 단계별 설명이 되는 <a href="../architecture/data_pipeline.html">인터랙티브 HTML</a></sub>
